...
import { createMCPClient, createMCPSession, cleanupMCPSession, mcpNavigate, mcpGetContent, mcpScreenshot } from '../utils/mcp-client.js';
...
describe('Basic Navigation Tests', () => {
  ...
  describe('Basic Page Navigation', () => {
    it('should navigate to a simple webpage and verify content', async () => {
    ...
    it('should navigate between multiple pages', async () => {
      const urls = [
        TEST_TARGETS.testing.theInternet,
        TEST_TARGETS.testing.testPages,
        TEST_TARGETS.ecommerce.sauceDemo
  ...
  describe('Page Content Verification', () => {
    it('should extract and verify page title and headers', async () => {
      await retryOperation(async () => {
        await mcpNavigate(mcpClient.client, sessionInfo.contextId, TEST_TARGETS.testing.theInternet);
    ...
    it('should extract specific element content', async () => {
      await retryOperation(async () => {
        ...
        try {
          const headingContent = await mcpGetContent(mcpClient.client, sessionInfo.contextId, 'h1');
  ...
  describe('Screenshot Capabilities', () => {
    it('should take screenshot of loaded page', async () => {
      await retryOperation(async () => {
        await mcpNavigate(mcpClient.client, sessionInfo.contextId, TEST_TARGETS.testing.theInternet);
