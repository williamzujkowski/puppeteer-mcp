...
describe('E-commerce Workflow Tests', () => {
  ...
  describe('Complete Purchase Flow', () => {
    it(
      'should complete full purchase workflow on Sauce Demo',
      async () => {
    ...
    it(
      'should handle cart modifications during shopping',
      async () => {
        await retryOperation(async () => {
          // Login
          await mcpNavigate(
  ...
  describe('Product Browsing and Filtering', () => {
    it(
      'should browse and sort products',
      async () => {
        await retryOperation(async () => {
          // Login
          await mcpNavigate(
          ...
          const initialContent = await mcpGetContent(
            mcpClient.client,
            sessionInfo.contextId,
            '.inventory_list',
          );
          ...
          const sortedContent = await mcpGetContent(
            mcpClient.client,
            sessionInfo.contextId,
            '.inventory_list',
          );
  ...
  describe('User Experience and Edge Cases', () => {
    it(
      'should handle problematic user account',
      async () => {
        await retryOperation(async () => {
          ...
          await mcpType(
            ...
            sessionInfo.contextId,
            '#user-name',
            TEST_CREDENTIALS.sauceDemo.problem.username,
          );
          await mcpType(
            mcpClient.client,
            sessionInfo.contextId,
            '#password',
            TEST_CREDENTIALS.sauceDemo.problem.password,
          );
          await mcpClick(mcpClient.client, sessionInfo.contextId, '#login-button');
      ...
      async () => {
        ...
        await retryOperation(async () => {
          ...
          await mcpType(
            ...
            sessionInfo.contextId,
            '#user-name',
            TEST_CREDENTIALS.sauceDemo.performance.username,
          );
          await mcpType(
            mcpClient.client,
            sessionInfo.contextId,
            '#password',
            TEST_CREDENTIALS.sauceDemo.performance.password,
          );
          await mcpClick(mcpClient.client, sessionInfo.contextId, '#login-button');
    ...
    it(
      'should maintain session state across navigation',
      async () => {
        await retryOperation(async () => {
          ...
          const cartBadge = await mcpGetContent(
            mcpClient.client,
            sessionInfo.contextId,
            '.shopping_cart_badge',
          );
  ...
  describe('Error Recovery and Resilience', () => {
    it(
      'should handle navigation errors and recover',
      async () => {
        await retryOperation(async () => {
          ...
          try {
            await mcpNavigate(
              mcpClient.client,
              sessionInfo.contextId,
              TEST_TARGETS.ecommerce.sauceDemo + 'non-existent-page',
            );
          ...
          await mcpNavigate(
            mcpClient.client,
            sessionInfo.contextId,
            TEST_TARGETS.ecommerce.sauceDemo + 'inventory.html',
          );
          await mcpWaitForSelector(mcpClient.client, sessionInfo.contextId, '.inventory_list');
