...
describe('Authentication Workflow Tests', () => {
  ...
  describe('Basic Authentication Patterns', () => {
    it(
      'should handle form-based authentication with valid credentials',
      async () => {
    ...
    it(
      'should handle partial authentication (wrong password)',
      async () => {
        await retryOperation(async () => {
          await mcpNavigate(
            mcpClient.client,
  ...
  describe('Session Management', () => {
    ...
    it(
      'should prevent access to secure areas without authentication',
      async () => {
        await retryOperation(async () => {
          ...
          await mcpNavigate(
            mcpClient.client,
            sessionInfo.contextId,
            TEST_TARGETS.testing.theInternet + '/secure',
          );
  ...
  describe('E-commerce Authentication', () => {
    it(
      'should handle multiple user types and roles',
      async () => {
        const userTypes = [
    ...
    it(
      'should handle locked user account properly',
      async () => {
        await retryOperation(async () => {
          await mcpNavigate(
            mcpClient.client,
          ...
          const usernameField = await mcpGetContent(
            mcpClient.client,
            sessionInfo.contextId,
            '#user-name',
          );
  ...
  describe('Authentication Security Features', () => {
    it(
      'should handle empty credentials validation',
      async () => {
        await retryOperation(async () => {
          await mcpNavigate(
            mcpClient.client,
    ...
    it(
      ...
      async () => {
        await retryOperation(async () => {
          ...
          const injectionAttempts = ["' OR '1'='1", "admin'--", "'; DROP TABLE users; --"];
  ...
  describe('Authentication State Persistence', () => {
    it(
      'should maintain authentication across page navigation',
      async () => {
        await retryOperation(async () => {
          // Login successfully
          await mcpNavigate(
