...
<Card
  title="API Reference"
  icon="🔌"
  href="/puppeteer-mcp/quick-reference/api-cheatsheet"
...
<Card
  ...
  icon="🤖"
  href="/puppeteer-mcp/guides/browser-automation"
...
<div class="text-center" markdown>
  **Built with ❤️ following [William Zujkowski's
